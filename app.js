...
body.addEventListener('keydown',function(e){//change pokemon using arrows
    if(e.key==='ArrowRight'){
        right();
...
previous.onclick = function(){left()};
    
let next = document.getElementById('next');
next.onclick = function(){right()};
...
function clear(){ //Erase de input data
    enter.value='';    
}
